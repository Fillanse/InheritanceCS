...
namespace Geometry
{
    public abstract class Shape
    {
        ...
        protected double FilterSize(double size) => size < MIN_SIZE ? MIN_SIZE : size > MAX_SIZE ? MAX_SIZE : size;
        public Shape(int startX, int startY, int lineWidth, Color color) { StartX = startX; StartY = startY; LineWidth = lineWidth; Color = color; }
